...
export const WhatsAppButton = () => (
  ...
  >
    <svg aria-hidden="true" focusable="false" viewBox="0 0 32 32" className="h-8 w-8">
      <path
        fill="#050405"
    ...
    <span className="pointer-events-none absolute -top-9 right-1 whitespace-nowrap rounded-full bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-white opacity-0 shadow-glow transition-opacity duration-300 group-hover:opacity-100">
